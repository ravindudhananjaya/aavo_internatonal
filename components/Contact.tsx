                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input type="text" required className="w-full bg-black/40 border border-white/10 rounded p-3 text-white focus:border-aavo-green focus:outline-none focus:bg-black/60 transition-all" />
                            </div>
                            <div className="space-y-2">
                                <label className={`block text-aavo-silver text-sm ${lang === 'jp' ? 'font-jp' : ''}`}>{c.form.company}</label>
                                <input type="text" className="w-full bg-black/40 border border-white/10 rounded p-3 text-white focus:border-aavo-green focus:outline-none focus:bg-black/60 transition-all" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input type="email" required className="w-full bg-black/40 border border-white/10 rounded p-3 text-white focus:border-aavo-green focus:outline-none focus:bg-black/60 transition-all" />
                            </div>
                             <div className="space-y-2">
                                <label className={`block text-aavo-silver text-sm ${lang === 'jp' ? 'font-jp' : ''}`}>{c.form.phone}</label>
                                <input type="tel" className="w-full bg-black/40 border border-white/10 rounded p-3 text-white focus:border-aavo-green focus:outline-none focus:bg-black/60 transition-all" />
                            </div>
                        </div>

                        <div className="space-y-2">
                             <label className={`block text-aavo-silver text-sm ${lang === 'jp' ? 'font-jp' : ''}`}>{c.form.message}</label>
                             <textarea required rows={5} className="w-full bg-black/40 border border-white/10 rounded p-3 text-white focus:border-aavo-green focus:outline-none focus:bg-black/60 transition-all resize-none"></textarea>
                        </div>
